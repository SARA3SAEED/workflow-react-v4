  ...
  return (
    <div className="relative bg-gray-50  pattern">
      ...
      >
        <Link
          to="/dashbord"
          className="flex aspect-square min-h-[32px] w-16 flex-col items-center justify-center gap-1 rounded-md p-1.5 bg-teal-100 bg-opacity-60 text-teal-600 dark:bg-teal-600 dark:text-sky-50"
        >
          <svg
        ...
        >
          <img src="https://img.icons8.com/?size=96&id=cykh8BZMTKkb&format=png" className="w-[60%]" alt="Users" />
        ...
        <Link
          ...
          className="flex aspect-square min-h-[32px] w-16 flex-col items-center justify-center gap-1 rounded-md p-1.5 text-gray-700 hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-slate-800"
        >
          <img src="https://img.icons8.com/?size=100&id=h88n73Ss5iTI&format=png" className="w-[60%]" alt="Projects" />
        ...
        <Link
          ...
          className="flex aspect-square min-h-[32px] w-16 flex-col items-center justify-center gap-1 rounded-md p-1.5 text-gray-700 hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-slate-800"
        >
          <img src="https://img.icons8.com/?size=160&id=3H7TP0gx37mp&format=png" className="w-[60%]" alt="Add New" />
        ...
        <a href="/" className="flex h-16 w-16 flex-col items-center justify-center gap-1 text-fuchsia-900 dark:text-gray-400">
          <img src={imglogo} className="w-20 m-2" alt="Logo" />
        </a>
      </nav>
    </div>
  )
